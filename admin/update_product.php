...
if (isset($_POST['update'])) {
    ...
    $update_product = $connection->prepare("UPDATE `products` SET name = ?, price = ?, details = ? WHERE id = ?");
    ...
    if (!empty($image_01)) {
        if ($image_size_01 > 2000000) {
            ...
            $update_image_01 = $connection->prepare("UPDATE `products` SET image_01 = ? WHERE id = ?");
    ...
    if (!empty($image_02)) {
        if ($image_size_02 > 2000000) {
            ...
            $update_image_02 = $connection->prepare("UPDATE `products` SET image_02 = ? WHERE id = ?");
    ...
    if (!empty($image_03)) {
        if ($image_size_03 > 2000000) {
            ...
            $update_image_03 = $connection->prepare("UPDATE `products` SET image_03 = ? WHERE id = ?");
...
<body>
    ...
    <section class="update-product">
        ...
        $select_products = $connection->prepare("SELECT * FROM `products` WHERE id = ?");
